...
exports.render = async (req, res, next) => {
	...
	data.page_tag = "fees"
	data.page_title = "THE HEIGHTS WELLNESS - Fees"
	data.page_desc = "The Heights Wellness Medical Service - Fees & Office Procedures"
	data.site_url = process.env.SITE_URL
	data.og_title = "The Heights Wellness - Fees"
	data.og_desc = "The Heights Wellness Medical Service - Fees & Office Procedures"
	data.twitter_title = "The Heights Wellness - Fees"
	data.twitter_desc = "The Heights Wellness Medical Service - Fees & Office Procedures"
	...
	const attributes = siteLang === "en" ? [
		'id', 'title', 'description', 'message', 'start', 'end', 'image', 'createdAt'
	] : [
		'id', ['title_es', 'title'], ['description_es', 'desc'], ['message_es', 'message'], 'start', 'end', 'image', 'createdAt'
	]
	...
	data.fees = await ClinicService.findAll({ where: { show_in_fee: 1, language: siteLang == "en" ? 17 : 25 } })
	...
	if (req.session.patient_id) {
		...
		data.patient_info = {
			id: 0, patient_id: 0, fname: "", lname: "", mname: "", gender: "M", dob: "", email: "", phone: "", mobile: "", address: "", city: "", state: "", zip: "", languag: 17, ethnicity: "", race: ""
		}
	}
